...
#SBATCH --account=nemotron_agents_dev
#SBATCH --time=4:00:00
#SBATCH --gres=gpu:8
#SBATCH --exclusive
...
MODEL_PATH="${HF_HOME}/hub/models--Qwen--Qwen3-4B-Instruct/snapshots/latest"
TRAIN_FILE="/path/to/swe_swegym_only_with_sifs.jsonl"
TEST_FILE="${TRAIN_FILE}"
CKPTS_DIR="${RESULTS_ROOT}/dapo-qwen3-4b-swe-8n-200t"
...
echo "Container ready. Waiting 90s for Ray to come up..."
sleep 90
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "${head_node}" \
    ...
    python3 -m verl.trainer.main_ppo \
            ...
            '+actor_rollout_ref.rollout.engine_kwargs.vllm.max-model-len=131072' \
            ...
            +reward_model.reward_kwargs.max_resp_len=102400 \
            'trainer.logger=["console","wandb"]' \
            trainer.project_name=${WANDB_USERNAME}-verl-nemogym-int \
            trainer.experiment_name=dapo-qwen3-4b-swe-8n-200t-verl-qa \
            ...
            +actor_rollout_ref.rollout.agent.agent_loop_config_path="${VERL_ROOT}/recipe/nemo_gym/configs/swe_4b_8n_200t.yaml" \
    2>&1
